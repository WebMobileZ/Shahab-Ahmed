        ...
        <div class="carousel-caption container">
          <div class="animated fadeInDown row">
              <div class="col-md-6 text-left">
                ...
                <p class="static-banner-one__text text-white">Become a part of our campaign, sign up for updates.</p>
              ...
              <div class="col-md-6 mmimg">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/mmimg.png" alt="">
              </div>
          </div>
        </div>
        <!--Caption-->
